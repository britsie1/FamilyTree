...
import type { TreeData, Person, Gender, TreeLink, PersonDocument } from '../../types/tree';
...
export const PersonInspector: React.FC<PersonInspectorProps> = ({
  ...
  const [isAttachingDoc, setIsAttachingDoc] = React.useState(false);
  ...
  const handleUploadDocument = async () => {
    ...
    try {
      ...
      onUpdatePerson(person.id, { documents: [...currentDocs, newDoc] });
                      ...
                      <div
                        onClick={() =>
                          onPreviewDocument
                            ...
                            : window.open(doc.webViewLink || `https://drive.google.com/file/d/${doc.driveFileId}/view`, '_blank')
                        }
