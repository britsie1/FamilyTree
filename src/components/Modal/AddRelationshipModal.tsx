...
export const AddRelationshipModal: React.FC<AddRelationshipModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-150">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 max-w-lg w-full overflow-hidden flex flex-col max-h-[92dvh] sm:max-h-[85vh]">
        {/* Header */}
        ...
        <div className="p-4 space-y-4 overflow-y-auto flex-1 text-sm">
          ...
          <div
            ...
            className="p-3.5 bg-gradient-to-r from-indigo-50/70 to-violet-50/50 hover:from-indigo-100/70 hover:to-violet-100/50 border border-indigo-200/80 rounded-xl cursor-pointer transition-all group flex items-center justify-between shadow-xs hover:shadow"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-semibold text-slate-900 text-sm group-hover:text-indigo-900">
                  {meta.newText}
                </h4>
            ...
            <button className="px-3 py-1.5 bg-indigo-600 group-hover:bg-indigo-700 text-white font-medium text-xs rounded-lg transition-colors">
              Add New
            </button>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center bg-slate-50 rounded-xl px-3 py-2 border border-slate-200 focus-within:border-indigo-500 focus-within:bg-white transition-all">
                ...
                existingCandidates.map((p) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center justify-between p-2.5 bg-white hover:bg-slate-50 border border-slate-200 hover:border-indigo-300 rounded-xl cursor-pointer transition-all group"
                    >
                      ...
                      <button className="flex items-center gap-1 text-xs font-medium text-indigo-600 group-hover:text-indigo-700 bg-indigo-50 group-hover:bg-indigo-100 px-2.5 py-1 rounded-lg flex-shrink-0 transition-colors">
        ...
        <div className="p-3 border-t border-slate-100 bg-slate-50/50 flex justify-end">
          <button
            onClick={onClose}
            className="px-3.5 py-1.5 bg-slate-200 hover:bg-slate-300 text-slate-700 font-medium text-xs rounded-xl transition-colors"
          >
            Cancel
          </button>
        </div>
