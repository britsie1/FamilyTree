...
export const TopNavbar: React.FC<TopNavbarProps> = ({
  ...
  return (
    <header className="h-14 sm:h-16 bg-white/95 backdrop-blur-md border-b border-slate-200 px-2.5 sm:px-4 flex items-center justify-between z-40 relative select-none gap-1 sm:gap-2">
      {/* Mobile Full-Width Search Overlay */}
      {isMobileSearchOpen && (
        <div className="absolute inset-0 bg-white z-50 px-3 flex items-center gap-2 animate-in fade-in duration-150">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-sm text-slate-800 placeholder-slate-400 focus:outline-none py-1.5"
          />
          {searchQuery && (
            <button
          ...
          {searchQuery.trim() && (
            <div className="absolute top-full left-0 right-0 bg-white border-b border-slate-200 shadow-xl max-h-[60vh] overflow-y-auto p-2 z-50">
              {searchResults.length === 0 ? (
                <div className="p-4 text-xs text-slate-400 text-center">No relatives found</div>
              ) : (
                searchResults.map((p) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center gap-3 p-2.5 hover:bg-indigo-50 rounded-xl cursor-pointer transition-colors active:bg-indigo-100"
                    >
      ...
      <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-shrink">
        ...
        <div className="min-w-0">
          {isEditingTitle ? (
            <input
              ...
              className="text-sm sm:text-base font-bold text-slate-800 border-b-2 border-indigo-600 focus:outline-none px-1 py-0.5 w-28 xs:w-36 sm:w-48"
            />
          ) : (
            <h1
            ...
            >
              ...
              <span className="text-[10px] sm:text-[11px] font-normal text-slate-400 bg-slate-100 px-1.5 py-0.5 rounded-full whitespace-nowrap flex-shrink-0">
        ...
        {onOpenTreeManager && (
          <button
            ...
            className="hidden sm:flex items-center gap-1 sm:gap-1.5 bg-slate-100 hover:bg-indigo-50 hover:border-indigo-300 hover:text-indigo-700 text-slate-700 px-2 sm:px-2.5 py-1.5 rounded-xl text-xs font-medium border border-slate-200 transition-all shadow-2xs flex-shrink-0 cursor-pointer"
      ...
      <div className="flex sm:hidden items-center gap-1 flex-shrink-0">
        <button
          ...
          className="w-9 h-9 flex items-center justify-center rounded-xl text-slate-600 hover:text-slate-900 hover:bg-slate-100 active:bg-slate-200 transition-colors cursor-pointer"
        ...
        <button
          ...
          className="w-9 h-9 flex items-center justify-center rounded-xl text-slate-700 hover:bg-slate-100 active:bg-slate-200 border border-slate-200 transition-colors cursor-pointer"
          title="Open Menu"
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex flex-col justify-end bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-200">
          ...
          />
          <div className="relative bg-white w-full rounded-t-3xl shadow-2xl border-t border-slate-200 p-4 sm:p-5 max-h-[88dvh] overflow-y-auto z-10 flex flex-col gap-4 animate-in slide-in-from-bottom duration-200 pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))]">
            ...
            <div className="grid grid-cols-2 gap-2">
              {onOpenTreeManager && (
                <button
                  ...
                  className="col-span-2 flex items-center justify-center gap-2 py-3 px-4 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-semibold text-sm rounded-xl border border-indigo-200 cursor-pointer active:scale-98 transition-all"
                >
              ...
              <button
                ...
                disabled={!canUndo}
                className="flex items-center justify-center gap-2 py-2.5 px-3 bg-slate-100 text-slate-700 font-medium text-xs rounded-xl border border-slate-200 disabled:opacity-40 cursor-pointer active:bg-slate-200 transition-colors"
              >
            ...
            <div className="space-y-2 pt-1 border-t border-slate-100">
              ...
              {onOpenShareModal && (
                <button
                  ...
                  className="w-full flex items-center justify-between py-2.5 px-3.5 bg-blue-50 text-blue-700 font-semibold text-xs rounded-xl border border-blue-200 cursor-pointer active:bg-blue-100 transition-colors"
                >
              ...
              {user ? (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 px-3.5 bg-white text-slate-700 font-semibold text-xs rounded-xl border border-slate-300 shadow-2xs cursor-pointer active:bg-slate-50 transition-colors"
                >
            ...
            <div className="space-y-1.5 pt-1 border-t border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-1.5 text-xs">
                <button
                  ...
                  className="p-2 text-left bg-slate-50 hover:bg-indigo-50 rounded-xl border border-slate-200 text-slate-700 font-medium active:bg-indigo-100"
                >
                  ⚡ Double In-Law
                </button>
                <button
            ...
            <div className="space-y-1.5 pt-1 border-t border-slate-100">
              ...
              <div className="grid grid-cols-3 gap-1.5 text-xs">
                <button
                  ...
                  className="flex flex-col items-center justify-center p-2.5 bg-slate-50 hover:bg-slate-100 rounded-xl border border-slate-200 text-slate-700 font-medium gap-1 active:bg-slate-200"
                >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 px-3 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold rounded-xl border border-slate-200 cursor-pointer active:bg-slate-300 transition-colors"
              >
            ...
            <div className="pt-1 border-t border-slate-100">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2 px-3 text-slate-500 hover:text-indigo-600 text-xs font-medium cursor-pointer"
              >
